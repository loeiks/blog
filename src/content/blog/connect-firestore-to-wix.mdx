...
Settings in CPU allocation and pricing are important for cost and performance. If you are testing do it like me but learn more about these things (using Google 🙃) if you want to use it in your website to understand how these works.
